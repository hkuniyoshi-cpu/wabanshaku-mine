 ...
 * Server-Side Rendered ブログ詳細ページ（和晩酌 嶺）
 *
 * 目的:
...
body{background:#0C0A08;color:#E8DFC8;font-family:'Zen Kaku Gothic New','Hiragino Sans',sans-serif;line-height:1.85;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
header{background:#E8DFC8;padding:16px 20px;text-align:center;position:sticky;top:0;z-index:10}
header a{color:#0C0A08;text-decoration:none;font-size:17px;letter-spacing:.24em;font-family:'Shippori+Mincho',serif;font-weight:600}
.wrap{max-width:720px;margin:60px auto;padding:0 24px 80px}
article.card{background:#1a1815;border-radius:4px;overflow:hidden;box-shadow:0 6px 28px rgba(0,0,0,.12)}
article.card img{width:100%;display:block;max-height:480px;object-fit:cover}
.card-body{padding:36px 38px 44px}
.date{font-size:12px;color:#B4A886;letter-spacing:.24em;display:block}
h1{margin:14px 0 28px;font-size:22px;line-height:1.7;font-weight:600;font-family:'Shippori+Mincho',serif;color:#E8DFC8;letter-spacing:.04em}
.text{font-size:15px;line-height:2.05;white-space:pre-wrap;color:#B4A886;word-break:break-word}
.back-wrap{margin-top:52px;text-align:center}
.back-btn{display:inline-block;padding:14px 36px;border:1.5px solid #E8DFC8;color:#E8DFC8;text-decoration:none;border-radius:2px;font-size:13px;letter-spacing:.2em;font-family:'Shippori+Mincho',serif;transition:all .35s ease}
.back-btn:hover{background:#E8DFC8;color:#0C0A08}
.produced-by{text-align:center;margin-top:64px;font-size:11px;letter-spacing:.24em;color:#B4A886;opacity:.6}
.produced-by a{color:#C9A860;text-decoration:none;transition:opacity .3s ease}
...
<link rel="icon" href="/favicon.svg">
<style>
body{background:#0C0A08;color:#E8DFC8;font-family:'Hiragino Sans',sans-serif;text-align:center;padding:120px 24px}
